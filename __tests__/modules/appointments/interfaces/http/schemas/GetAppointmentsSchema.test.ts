...
describe('GetAppointmentsSchema', () => {
    ...
    describe('GetAppointmentsQuerySchema', () => {
        ...
        it('should validate lastKey', () => {
            // Arrange & Act
            const result = GetAppointmentsQuerySchema.parse({ lastKey: 'some-key-123' });
    ...
    describe('Error messages', () => {
        it('should provide meaningful error message for invalid insuredId', () => {
            ...
            try {
                ...
                expect(zodError.issues[0].message).toContain('must be exactly 5 digits');
            }
        });
        ...
        it('should provide meaningful error message for invalid limit', () => {
            ...
            try {
                ...
                expect(error).toBeInstanceOf(ZodError);
                const zodError = error as ZodError;
                expect(zodError.issues[0].message).toContain('must be between 1 and 100');
            }
        });
    });
});
