...
describe('Appointment Entity', () => {
  ...
  describe('create()', () => {
    it('should create a new appointment with valid data', () => {
      ...
      expect(appointment.slotDatetime).toEqual(
        validAppointmentData.slotDatetime
      );
    ...
    it('should throw ValidationError for invalid insured ID', () => {
      ...
      expect(() => Appointment.create(invalidData)).toThrow(
  ...
  describe('fromPersistence()', () => {
    ...
    it('should throw ValidationError for invalid appointment ID format', () => {
      ...
      expect(() => Appointment.fromPersistence(invalidData)).toThrow(
        ValidationError
      );
      expect(() => Appointment.fromPersistence(invalidData)).toThrow(
  ...
  describe('Status Management', () => {
    ...
    it('should mark pending appointment as completed', () => {
      ...
      expect(completedAppointment.appointmentId).toBe(
    ...
    it('should mark pending appointment as failed', () => {
      ...
      expect(failedAppointment.updatedAt.getTime()).toBeGreaterThanOrEqual(
        appointment.updatedAt.getTime()
      );
    });
