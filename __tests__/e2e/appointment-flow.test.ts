...
async function apiRequest(
    ...
    const options: RequestInit = {
        ...
        headers: {
            ...
            Origin: 'https://test-client.com', // Add Origin header to trigger CORS
        },
    };
...
describe('E2E: Medical Appointments API Flow', () => {
    ...
    describe('POST /appointments - Appointment Creation Flow', () => {
        ...
        it('should create CL appointment and route to CL queue', async () => {
            // 1. Create appointment
            const appointmentData = {
                insuredId: '54321',
                countryISO: 'CL',
        ...
        it('should handle duplicate appointments (idempotency)', async () => {
            const appointmentData = {
                insuredId: '99999',
                countryISO: 'PE',
                scheduleId: 300,
    ...
    describe('GET /appointments/{insuredId} - Appointment Retrieval', () => {
        it('should retrieve appointments for existing insured', async () => {
        ...
        it('should return empty list for non-existing insured', async () => {
    ...
    describe('CORS and Headers', () => {
        it('should include CORS headers in responses', async () => {
            ...
            // CORS origin header should be present - either '*' or the specific origin
            const corsOrigin = response.headers.get('access-control-allow-origin');
            expect(corsOrigin).toBeTruthy();
            expect(['*', 'https://test-client.com']).toContain(corsOrigin);
        });
    });
});
