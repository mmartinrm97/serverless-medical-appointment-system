import { Appointment, type CountryISO } from '../../src/modules/appointments/domain/entities/Appointment.js';
import { createAppointmentConfirmedEvent, type AppointmentConfirmedData } from '../../src/modules/appointments/domain/events/AppointmentConfirmed.js';
...
export const mockValidationError = new Error('Validation failed: Invalid date format');
