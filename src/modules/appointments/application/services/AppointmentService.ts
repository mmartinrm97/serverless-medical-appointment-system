...
import type {
  ProcessAppointmentPEResult,
  AppointmentSQSMessage,
} from '../use-cases/ProcessAppointmentPE.js';
import type {
  ProcessAppointmentCLResult,
  AppointmentCLSQSMessage,
} from '../use-cases/ProcessAppointmentCL.js';
...
export class AppointmentService {
   ...
   */
  public async listAppointmentsByInsured(
    insuredId: string
   ...
   */
  public async confirmAppointmentFromEvent(
    event: unknown
   ...
   */
  public async processAppointmentPE(
   ...
   * @returns Promise with processing result
   */
  public async processAppointmentCL(
