...
export class ChileStrategy implements ICountryStrategy {
    ...
    public async processAppointment(appointment: Appointment): Promise<AppointmentProcessResult> {
        logger.info(`Processing appointment for Chile: ${appointment.appointmentId}`);
        ...
        try {
            ...
            logger.info(`Appointment successfully processed for Chile: ${appointment.appointmentId}`);
            ...
            logger.error(`Failed to process appointment for Chile: ${appointment.appointmentId} - ${error}`);
    ...
    private async writeToChileDatabase(appointment: Appointment): Promise<void> {
        ...
        logger.debug(`Simulated Chile database write for appointment: ${appointment.appointmentId}`);
