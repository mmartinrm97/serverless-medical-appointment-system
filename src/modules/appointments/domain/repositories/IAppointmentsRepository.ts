...
export interface IAppointmentsRepository {
     ...
     */
    updateStatus(appointmentId: string, status: 'completed' | 'failed'): Promise<Appointment | null>;
     ...
     */
    findByInsuredAndSchedule(insuredId: string, scheduleId: number): Promise<Appointment | null>;
}
