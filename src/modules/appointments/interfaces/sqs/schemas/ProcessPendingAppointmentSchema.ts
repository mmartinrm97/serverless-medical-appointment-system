...
// Types
export type ProcessPendingAppointmentMessage = z.infer<typeof ProcessPendingAppointmentMessageSchema>;
export type PendingAppointmentPayload = z.infer<typeof PendingAppointmentPayloadSchema>;

// Validation functions
export const validateProcessPendingAppointmentMessage = (data: unknown): ProcessPendingAppointmentMessage => {
    return ProcessPendingAppointmentMessageSchema.parse(data);
};

export const validatePendingAppointmentPayload = (data: unknown): PendingAppointmentPayload => {
