...
// Types
export type ProcessCompletedAppointmentMessage = z.infer<
  typeof ProcessCompletedAppointmentMessageSchema
>;
export type CompletedAppointmentPayload = z.infer<
  typeof CompletedAppointmentPayloadSchema
>;

// Validation functions
export const validateProcessCompletedAppointmentMessage = (
  data: unknown
): ProcessCompletedAppointmentMessage => {
  return ProcessCompletedAppointmentMessageSchema.parse(data);
};

export const validateCompletedAppointmentPayload = (
  data: unknown
