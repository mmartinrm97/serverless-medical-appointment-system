...
export const GetAppointmentsQuerySchema = z.object({
    ...
    limit: z
        ...
        .optional()
        .describe('Maximum number of appointments to return (default: 50, max: 100)'),
 ...
 */
export type GetAppointmentsPathParams = z.infer<typeof GetAppointmentsPathSchema>;
export type GetAppointmentsQueryParams = z.infer<typeof GetAppointmentsQuerySchema>;
 ...
 */
export function validateGetAppointmentsPath(pathParameters: unknown): GetAppointmentsPathParams {
 ...
 * @throws {z.ZodError} When validation fails
 */
export function validateGetAppointmentsQuery(queryParameters: unknown): GetAppointmentsQueryParams {
