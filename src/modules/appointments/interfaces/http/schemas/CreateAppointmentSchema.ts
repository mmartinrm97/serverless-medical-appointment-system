...
export const CreateAppointmentResponseSchema = z.object({
    appointmentId: z
        .string()
        .describe('ULID generated for the new appointment'),

    status: z
        .literal('pending')
        .describe('Initial status of the appointment'),
});
 ...
 */
export function validateCreateAppointmentRequest(data: unknown): CreateAppointmentRequest {
